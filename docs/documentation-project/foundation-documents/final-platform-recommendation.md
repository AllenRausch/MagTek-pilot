...
**Final Platform Recommendation: GitBook vs Jekyll**

**Unified Information System Platform Selection**
...
* Day 1: Platform accessible, team invited
* Day 2-5: Initial structure created, templates configured
* Week 2: First documents migrated and published
* Week 3: Team creating and editing independently

**Time to demonstrate value: 2-3 weeks**

**Jekyll Timeline to First Value:**

* Week 1-2: Technical writer learns Jekyll/Liquid/Git workflows (40-50 hours)
* Week 3-4: Training materials created, initial repository configured
* Week 5-6: Team training begins
* Week 7-9: First users attempting independent contributions
* Week 9-11: First documents successfully migrated

**Time to demonstrate value: 10+ weeks**

The 8-week gap is the difference between having a functioning documentation system prototype at the end of February versus the beginning of April.
...
**See Appendix F: TCO Calculation Methodology for more information**

**See Appendix G: Addressing Cost Concerns for more information**

**Conclusion**

The choice between GitBook and Jekyll is fundamentally about speed, risk, and total cost of ownership.

**Speed:** GitBook enables rapid implementation (2-3 weeks vs. 10+ weeks), faster daily operations (3-5x), and quicker user proficiency (2-4 hours vs. 4-12 hours).
...
* **GitBook:** 7 participants (77.8%)
* **Jekyll:** 1 participant (11.1%)
* **Neutral/No preference:** 1 participant (11.1%)

**Critical Insights from Feedback**

**The Technical Burden is Real—Even for Engineers**

Even experienced developers struggled with Jekyll. Erik Young, a firmware developer with moderate documentation experience, gave Jekyll the lowest possible ratings (1 out of 5) for basic tasks like fixing typos and managing tables. His assessment that Jekyll would be "a huge burden on developers" contradicts the assumption that technical users will easily adopt the platform.

Jay Guevara's perspective reinforces this. Despite being a Hardware Engineer Manager, he rated Jekyll as 1-2 for intuitiveness and confidence without training. His key concern: "Learning curve with syntax." When asked what he liked most about GitBook, he said it "looks and feel like Microsoft Word"—the familiar interface that enables immediate productivity.

**Training Won't Eliminate Friction**

Nedal's concern about infrequent users forgetting Jekyll procedures is particularly relevant. The CTO noted that non-engineers "might run into issues if they don't use enough (they will forget)" and recommended video training for reference. This suggests ongoing friction even after initial training investment.

**Cost Concerns are Isolated**

Only one participant (Nedal) cited cost as the determining factor. Donnie specifically valued "less dependencies," Long prioritized "ease of use," Erik emphasized tables, quick edits, and linking, and Jay identified "ease of use" as most important, noting GitBook "may be easier to use coming from a user who has no HTML or programming experience."

Larry's perspective is particularly telling: he'd favor the tool with the easiest learning curve "regardless of cost" if capabilities are equivalent.

**The WYSIWYG Advantage is Overwhelming**

Multiple participants compared GitBook to Google Docs and Microsoft Word—familiar, accessible tools. This comparison never appeared for Jekyll. Jay's comment captures this perfectly: "I prefer GitBook over Jekyll mainly it looks and feel like Microsoft Window \[Word]."

The visual, immediate-feedback interface consistently scored 4-5 while Jekyll's code-based editing scored 1-3.

**Qualitative Analysis by User Segment**

**Non-Technical Users (QA, Test, Marketing, Hardware)**

**Strong GitBook Preference:** This segment showed the most decisive preference for GitBook across all scenarios:

**Donnie James (Test Engineer, Basic Experience)**

* Rated GitBook 4-5 across all scenarios vs Jekyll 3-4
* Key quote: "Seems more geared for instructions and less for development"
* Critical factor: "Ease of use. Less dependencies"
* Concern with Jekyll: "VS Code dependency"

**Long Vu (QA Engineer, Basic Experience)**

* Rated GitBook 5 across all scenarios vs Jekyll 2-3
* Concern with GitBook: "Converting existing documents"
* Key feature requirement: "Import documents and auto format"
* Jekyll described as "Not GUI friendly"

**Jay Guevara (Hardware Engineer Manager, Basic Experience)**

* Rated GitBook 4 across most scenarios vs Jekyll 1-2
* GitBook strengths: "Looks and feel like Microsoft Word"
* Jekyll concerns: "Learning curve with syntax" and "steep learning curve with the syntax"
* Confidence without training: GitBook rated 4, Jekyll rated 1
* Team workflow fit: GitBook rated 4, Jekyll rated 1
* Critical quote: "GitBook may be easier to use coming from a user who has no HTML or programming experience"

**Pattern:** Non-technical users consistently rated GitBook 4-5 for ease of use and intuitiveness, while rating Jekyll 1-3. The WYSIWYG interface was repeatedly cited as the critical differentiator. Speed of learning and speed of execution are directly correlated with interface familiarity.

**Technical Users (Developers, Engineers)**

**Erik Young (FW Developer, Moderate Experience)**

* Most extreme preference gap: GitBook 4-5 vs Jekyll 1-2 across scenarios
* GitBook described as "Easy. Similar to Google Docs"
* Jekyll concerns: "Very complicated! Have to edit in HTML and then commit"
* Table management in Jekyll: "Difficult. Must do it in text file. CSS is separated from text file table. Doing it with CSS is troublesome"
* Navigation in Jekyll: "HTML links hard"
* Overall Jekyll impression: "Not at all \[intuitive]. Feels like doing Web development"
* Critical quote: "Do not like it. Too many steps. Too hard to edit... Difficult. Will be a huge burden on developers"

**Dave Xu (FW Engineer, Moderate Experience)**

* Slight GitBook preference based on "Easier to use"
* Rated both platforms 3-5 across scenarios with GitBook averaging slightly higher
* Both platforms rated equally (5) for multi-person review workflow
* No strong concerns noted for either platform

**Larry Meyers (VP, Chief Architect, Advanced User)**

* No strong preference: "both are 'tools' with a given set of capabilities, pros/cons, costs, and learning curves"
* Key insight: "I would tend to favor the tool that has the easiest learning curve and set of needed capabilities regardless of cost. IF they are both equivalent, then I would tend to favor the lower cost implementation"
* Critical requirement: "whichever platform is selected, sufficient training needs to be provided to all users"
* Strategic perspective: "we need to move away from 'monolithic' Word/PDF docs, and adopt browser based documentation"

**Nedal Almomani (CTO, Advanced Experience)**

* Only participant recommending Jekyll
* Acknowledged GitBook advantages: "more visual and word like interface" and "easier for non-tech users"
* Jekyll preference driven by cost: "Even though GitBook is more visual and might be faster to train and get users to adopt it, I am afraid, it is too expensive"
* Mitigation strategy: "We can support the handful of users who need access with training"
* Jekyll concerns: "Non engineers might require more training and might run into issues if they don't use enough (they will forget). Ideally, video training so people can reference later on"
* Rated both platforms 4-5 for most scenarios, showing technical users can adapt to either

**Pattern:** Advanced technical users acknowledge both platforms are viable but recognize GitBook's superior accessibility and speed advantages. The sole Jekyll recommendation is cost-driven with explicit acknowledgment of higher training burden and slower adoption.

**Scenario-Specific Performance Analysis**

**Scenario 1: Quick Edit - Fix a Typo**

**Winner: GitBook (decisive)**

* GitBook average: 4.6/5
* Jekyll average: 2.8/5
* Widest performance gap of all scenarios

Erik's comment captures the divide: GitBook rated 5 ("Easy") vs Jekyll rated 1 ("Very complicated! Have to edit in HTML")

Jay: Both rated 4, but noted Jekyll's "learning curve with syntax"

**Speed Implications:** A typo fix in GitBook takes 30 seconds. In Jekyll, it requires opening Codespaces, navigating file structure, editing Markdown, committing changes, and waiting for rebuild—3-5 minutes minimum.

**Scenario 2: Content Reuse - Update Shared Warning**

**Winner: GitBook (moderate)**

* GitBook average: 4.1/5
* Jekyll average: 3.1/5
* Nedal's Jekyll comment: "Requires more steps. Easy after training. Not sure if we covered all areas"
* Jay: GitBook rated 3, Jekyll rated 1—significant gap for basic user

**Speed Implications:** GitBook's snippet functionality allows drag-and-drop reuse. Jekyll requires understanding Liquid includes and file path structures.

**Scenario 3: Table Management - Update Specs**

**Winner: GitBook (decisive)**

* GitBook average: 4.4/5
* Jekyll average: 2.9/5
* Erik: GitBook "GUI based, just like Google Docs. Easy to Insert and delete" vs Jekyll "Difficult. Must do it in text file. CSS is separated"
* Jay: GitBook rated 4, Jekyll rated 1—clear preference for visual editing
* Second-widest performance gap

**Speed Implications:** Creating a table in GitBook is identical to Excel/Word. In Jekyll, it requires Markdown syntax or HTML, with styling separated into CSS files.

**Scenario 4: New Document from Template**
...
**Speed Implications:** GitBook templates are point-and-click. Jekyll templates require understanding YAML front matter, navigation hierarchy, and file organization.

**Scenario 5: Multi-Person Review Workflow**

**Winner: Tie**

* GitBook average: 4.3/5
* Jekyll average: 4.0/5
* Only scenario where Jekyll performed comparably
...
* GitBook average: 4.1/5
* Jekyll average: 3.3/5
* Erik: GitBook "GUI base plus linking" vs Jekyll "HTML links hard"
* Jay: Both rated 3, showing navigation complexity similar

**Speed Implications:** GitBook auto-updates internal links when pages move. Jekyll requires manual link maintenance and understanding of relative path structures.

**Appendix B: Operational Constraints: The Hidden Cost of Complexity**

The choice between GitBook and Jekyll is not about features or capabilities—both platforms can technically deliver browser-based documentation. The choice is about speed, people, processes, and sustainable operations. Jekyll imposes significant operational constraints that will slow implementation, user onboarding, day-to-day production, and create ongoing friction.

These constraints translate into direct, measurable costs:

**Technical Writer Training: The Implementation Bottleneck**
...
* Basic Liquid includes syntax: 4-6 hours
...
* Conservative: 30 hours × $80/hr = $2,400
* Realistic: 45 hours × $80/hr = $3,600

**Available Training Resources:**

Learning will primarily be self-taught for various aspects of the custom tech stack. No comprehensive courses exist for this specific combination.

* **Jekyll Core:** Pluralsight course ($20-40), Mike Dane YouTube series (free), Jekyll documentation (free)
* **Liquid Templating:** No Jekyll-specific courses exist. Must learn from Shopify Liquid docs and translate to Jekyll context
* **JustTheDocs Theme:** No training courses available. Only GitHub README and reference documentation
* **Total Course Fees:** $20-40 (everything else is self-study through docs)
...
**With Jekyll:** Even after becoming proficient, the Technical Writer is a single point of failure with specialized knowledge. This creates project vulnerability:

* If the Technical Writer leaves, institutional knowledge is lost
...
* Video recordings for each workflow
...
| **User Type**                              | **Hours Needed** | **# Users** | **Rate** | **Total Cost** |
| ------------------------------------------ | ---------------- | ----------- | -------- | -------------- |
...
* GitBook: Team productive in 2-4 hours
* Jekyll: Team productive in 4-12 hours (if they don't forget)
...
**Critical Factor:** Every function in Jekyll takes longer than the equivalent in GitBook. The differences compound across hundreds of edits, creating measurable delays in implementation and ongoing operations.
...
**Jekyll's Inherent Slowdowns:**

1. **Editing in Code vs WYSIWYG**
...
* **GitBook:** Drag-and-drop from snippet library (15 seconds)
* **Jekyll:** Navigate to \_includes folder → find correct file → copy include code → paste into document → verify path (2-3 minutes)
* **Speed multiplier:** 8-12x slower

3. **Table Management**

* **GitBook:** Click cells to edit, drag borders to resize, use toolbar for formatting (works like Excel)
* **Jekyll:** Edit ASCII-style Markdown tables or write HTML → modify CSS classes for styling → preview → debug alignment issues
* **Jay's feedback confirms this:** GitBook rated 4 for table management vs Jekyll rated 1
* **Erik's feedback:** "Difficult. Must do it in text file. CSS is separated from text file table. Doing it with CSS is troublesome"

4. **Site Organization/Taxonomy**

* **GitBook:** Drag-and-drop folders and pages in visual tree hierarchy
* **Jekyll:** Edit YAML front matter in each file:
  * parent: for hierarchy
  * nav\_order: for sorting
  * has\_children: true for section pages
  * nav\_exclude: true to hide pages
* Understanding and maintaining this across hundreds of documents is error-prone and slow

5. **Review/Approval Workflow**

* **Jekyll:** Create branch → commit changes → create PR → review Markdown diff → approve → merge
* Users must understand Git concepts (branches, commits, PRs, merges)
* **GitBook:** Same PR workflow but visual diff makes review faster
* Both rated similarly (4.0-4.3) because Git workflow is inherent to both

6. **Codespaces Overhead**
...
**Programmer's Manual Migration**

**GitBook Approach:**

1. Import Word documents directly
2. GitBook auto-converts formatting
3. Manual cleanup of complex tables and images
4. Reorganize using visual interface
5. Estimated time: 10-15 weeks

**Jekyll Approach:**

1. Convert Word to Markdown (requires tools or manual conversion)
2. Fix formatting issues from conversion
3. Extract and organize images into assets folder
4. Write Markdown for complex tables (or HTML)
5. Add YAML front matter to every file
6. Configure navigation hierarchy
7. Debug broken links and formatting
8. Estimated time: 25-30 weeks

**Speed Impact:** Jekyll adds 10-15 weeks to migration timeline—directly conflicting with Nedal's requirement for rapid implementation.

**Quantifying the Production Slowdown**

**Conservative Estimate:** Jekyll operations are 3-5x slower on average across all common tasks.
...
| **Metric**                      | **GitBook** | **Jekyll**    | **Impact**    |
| ------------------------------- | ----------- | ------------- | ------------- |
| Time to first published content | 2-3 weeks   | 10+ weeks     | 8-week delay  |
| User training to competency     | 2-4 hours   | 4-12 hours    | 2-3x slower   |
| Typo fix time                   | 30 seconds  | 3-5 minutes   | 6-10x slower  |
| Table creation                  | 2 minutes   | 10-15 minutes | 5-7x slower   |
| Content reorganization          | 15 seconds  | 10-20 minutes | 40-80x slower |
| Daily production efficiency     | 100%        | 33-50%        | 50-67% slower |
...
* Local caching enables offline viewing
...
* Reversion to Word documents or forced platform change
* Lost time and investment cannot be recovered

**Appendix E: Strategic Considerations**

**Organizational Context**

**Current State:**

* Programmer's Manual as primary documentation (Word)
* Poor external customer support site
* No established documentation culture or infrastructure
* Minimal technical documentation experience across team
* GitHub available but underutilized for documentation

**Critical Success Factors:**

1. **Speed of Implementation**

* Cannot afford 8-week delays
* Need working system in weeks, not months

2. **Rapid Adoption & Ease of Use**

* Must get non-technical users contributing quickly
* Cannot rely on extensive training programs
* Interface must be intuitive, not learned

3. **Low Friction & Speed of Execution**

* Cannot add barriers that perpetuate Word document reliance
* Daily operations must be faster than current state
* Users must prefer the new system over old habits

4. **Scalability**

* Platform must grow with organizational needs
* Adding users should not require extensive training investment
* Content volume should not create maintenance burden

5. **Sustainability**

* Must be maintainable without constant technical intervention
* Cannot depend on single individual's expertise
* Must survive personnel changes

**Jekyll's Hidden Assumptions**

**The Jekyll recommendation assumes:**

1. All users will complete extensive training ✗ _Contradicted by feedback_
2. Infrequent users will retain complex workflows ✗ _Nedal explicitly doubts this_
3. Technical support will always be available ✗ _Creates dependency_
4. Lower licensing cost justifies much higher operational costs ✗ _TCO analysis disproves this_
5. Implementation speed is not critical ✗ _Contradicts Nedal's requirement_

**These assumptions are contradicted by:**

* Erik's assessment: Jekyll will be "a huge burden on developers"
* Nedal's concern: Non-engineers "will forget" if they don't use it constantly
...
Both platforms enable the strategic goal of browser-based documentation. However:
...
* Developers freed from documentation infrastructure burden
* Scales naturally as team grows

**Jekyll's Path:**

* **Weeks 1-8:** Technical Writer learning, training materials creation
* **Weeks 9-12:** Team training begins
* **Weeks 13-24:** Migration of Programmer's Manual
* **Month 6:** Demonstrate working system
* Content creators must also be coders
* Non-technical teams require constant technical support
* Developers become documentation infrastructure maintainers
* Each new user requires significant training investment
* Result: 4-5 month delay vs. Nedal's timeline

Larry's vision of "multiple browser windows" with easy linking and bookmarking is achievable with either platform, but GitBook delivers it in 1-2 months while Jekyll requires 5-6 months and creates ongoing friction.

**Appendix F: TCO Calculation Methodology**
...
* User access management: 1 hour
* Template updates: 2 hours
* Feature reviews: 1 hour
* User support: 2 hours (minimal due to intuitive interface)
* **Monthly: 6 hours × $80/hr = $480**
* **Annual: $5,760**
...
**We recommend GitBook as the Unified Information System platform.**
...
* Infrequent users will struggle with Jekyll regardless of training
* "Forgetting effect" creates permanent productivity drag
* Precedent of abandoned systems (support site CMS)
...
A: Based on 27 hours/month of required maintenance activities:
...
| **Monthly Total**                               | **27**          | **$2,160**       |
| **Annual Total**                                | **324**         | **$25,920**      |

User support requires 12 hours/month due to:
...
* Lost time: 2 hours/day × 20 workdays/month = 40 hours/month
...
A: Jekyll requires 21 additional hours/month due to:

**Technical maintenance** (not required for GitBook):
...
* Jekyll's code-based interface requires constant support
* User feedback confirms: Erik rated Jekyll 1/5 for intuitiveness
* Jay rated confidence without training as 1/5 for Jekyll vs. 4/5 for GitBook
* Nedal's concern: "they will forget" without constant use
* **Additional support: 10 hours**

**Template maintenance** (3 hrs for Jekyll vs. 2 hrs for GitBook):
...
**Q: Why does Jekyll require 40-50 hours of Technical Writer self-training?**

A: Jekyll requires mastery of an entire technical stack before training materials can be created:

* Markdown fundamentals: 8-10 hours
* YAML front matter & navigation: 6-8 hours
* Liquid templating syntax: 4-6 hours
* Git/GitHub/Codespaces workflow: 6-8 hours
* Jekyll site structure: 3-4 hours
* Practice & troubleshooting: 10-15 hours
* **Total: 40-50 hours**

GitBook requires minimal training because the WYSIWYG interface is self-explanatory.

**Q: Why do you estimate 10+ weeks to first value for Jekyll vs. 2-3 weeks for GitBook?**

A: Jekyll timeline includes:

* Weeks 1-2: Technical Writer learns entire stack (40-50 hours)
* Weeks 3-4: Create comprehensive training materials from scratch
...
* Day 1: Platform access, basic orientation
...
**Q: Doesn't Jekyll offer more customization flexibility?**

A: Yes, but we don't need it. Requirements are:
...
Both platforms meet these requirements. Jekyll's additional customization comes at the cost of complexity we don't need.

**Q: What if we need to migrate away from GitBook later?**

A: GitBook stores content in Markdown with clean export:

* One-click export to Markdown files
* Standard format compatible with any platform
* Can migrate to Jekyll, MkDocs, Docusaurus, or any Markdown-based system
* No vendor lock-in for content

Migration risk is low.

**Q: Can we reduce Jekyll costs by doing less maintenance?**

A: No. The 27 hours/month represents minimum required maintenance:

* Security patches cannot be skipped (creates vulnerabilities)
* Dependency updates prevent breaking changes
* User support time reflects actual complexity (validated by user feedback)
* Reducing support doesn't reduce user confusion—it increases frustration and system abandonment risk

**Q: What about using Jekyll's simpler themes instead of JustTheDocs?**

A: Simpler themes reduce some complexity but don't address core issues:
...
The complexity is inherent to the code-based approach.

**User Adoption Questions**

**Q: Can't we just mandate that users learn Jekyll?**

A: Mandates don't overcome usability barriers:

* 77.8% user preference for GitBook indicates genuine usability gap
* Forced adoption risks passive resistance and workarounds
* Users will revert to familiar tools (Word) when frustrated
* Productivity losses persist regardless of mandate
* Nedal explicitly acknowledged "they will forget" problem

Successful tool adoption requires user buy-in, not just mandates.

**Q: Won't younger/technical hires prefer Jekyll's developer workflow?**

A: User feedback contradicts this:
...
A: This indicates system failure, not cost savings:

* Goal is broad organizational documentation participation
* 2-3 users means non-technical staff abandoned the system
* Confirms the adoption risk predicted by user feedback
* Jekyll's complexity directly caused the failure
* Better to invest in a system people actually use

Limited adoption with Jekyll wastes all training investment.

**Strategic Questions**

**Q: Can we start with Jekyll and switch to GitBook later if it doesn't work?**
...
**Q: What's the minimum viable GitBook configuration?**
