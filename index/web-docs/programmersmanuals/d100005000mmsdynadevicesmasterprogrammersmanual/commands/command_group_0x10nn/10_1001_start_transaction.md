...
1. If user event notifications are enabled via [Property 1.2.7.1.2.1 – User Event Notification Controls Enable](../../../../../../docs/web-docs/ProgrammersManuals/D100005000MMSDynaDevicesMasterProgrammer'sManual/Commands/Properties/#property-1-2-7-1-2-1),\
   the cardholder may present a card before the host calls this command.\
   In that case, the device sends [Notification 0x1001 – Device Information Update](../../../../../../docs/web-docs/ProgrammersManuals/D100005000MMSDynaDevicesMasterProgrammer'sManual/Commands/Notifications/#notification-0x1001),\
...
2. **MSR Only**: If the cardholder swipes before the transaction starts,\
   ...
   [Property 1.2.7.1.2.2 – User Event Notification MSR Data Timeout](../../../../../../docs/web-docs/ProgrammersManuals/D100005000MMSDynaDevicesMasterProgrammer'sManual/Commands/Properties/#property-1-2-7-1-2-2).
...
| RAAT   | Reader Action/Access Type _(MagTek Internal Only)_ | Specifies what action the reader should allow |
...
* **MSR Only**: Temporary storage of swiped card data is controlled by [Property 1.2.7.1.2.2 – User Event Notification MSR Data Timeout](../../../../../../docs/web-docs/ProgrammersManuals/D100005000MMSDynaDevicesMasterProgrammer'sManual/Commands/Properties/#property-1-2-7-1-2-2).
